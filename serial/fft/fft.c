...
void fft_aux(int n, COMPLEX * in, COMPLEX * out, int *factors, COMPLEX * W, int nW)
{
     ...
     if (r < n) {
	   ...
	   * recurse 
	   */
	  if      (r == 32) fft_unshuffle_32(0, m, in, out, m);
	  else if (r == 16) fft_unshuffle_16(0, m, in, out, m);
	  else if (r ==  8) fft_unshuffle_8(0, m, in, out, m);
	  else if (r ==  4) fft_unshuffle_4(0, m, in, out, m);
	  else if (r ==  2) fft_unshuffle_2(0, m, in, out, m);
	  else              unshuffle(0, m, in, out, r, m);
      ...
      * of length r
      */
     if      (r ==  2) fft_twiddle_2(0, m, in, out, W, nW, nW / n, m);
     else if (r ==  4) fft_twiddle_4(0, m, in, out, W, nW, nW / n, m);
     else if (r ==  8) fft_twiddle_8(0, m, in, out, W, nW, nW / n, m);
     else if (r == 16) fft_twiddle_16(0, m, in, out, W, nW, nW / n, m);
     else if (r == 32) fft_twiddle_32(0, m, in, out, W, nW, nW / n, m);
     else              fft_twiddle_gen(0, m, in, out, W, nW, nW / n, r, m);
